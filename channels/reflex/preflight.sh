...
PERSIST_DIR="${STATE_PERSIST_DIR:-/var/lib/albunyaan}"
...
mkdir -p "$PERSIST_DIR" || fail "cannot create persistent dir $PERSIST_DIR"
[[ -w "$PERSIST_DIR" ]] || fail "persistent dir not writable: $PERSIST_DIR"
echo "preflight OK"
